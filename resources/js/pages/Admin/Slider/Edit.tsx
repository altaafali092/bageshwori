...
import { index, store, update } from "@/routes/admin/sliders"
...
export default function SliderEdit({ slider }: SliderProps) {
            ...
            <div className="flex h-full flex-1 flex-col gap-6 p-4">
                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h1 className="text-2xl font-bold tracking-tight">Update Slider</h1>
                            <p className="text-muted-foreground">
                                Update the slider details with image and description.
                            </p>
                        </div>
                    </div>
                </div>
