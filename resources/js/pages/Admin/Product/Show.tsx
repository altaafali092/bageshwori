            ...
            <CardTitle className="flex items-center text-xl">
              ...
              {product.image && product.image.length > 0 && (
                <Badge variant="outline" className="ml-2">
                  {product.image.length} {product.image.length === 1 ? 'image' : 'image'}
                </Badge>
              )}
            </CardTitle>
          </CardHeader>
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center space-x-3">
                  <div
                    className={`w-4 h-4 rounded-full ${product.in_stock ? "bg-emerald-500" : "bg-red-500"
                      }`}
                  />
                  <span
                    className={`font-semibold ${product.in_stock ? "text-emerald-700" : "text-red-700"
                      }`}
                  >
                    {product.in_stock ? "Available" : "Unavailable"}
                  </span>
                  <span className="text-gray-500 text-sm">
                    • {product.in_stock ? "Ready to order" : "Not available for order"}
                  </span>
                </div>
              </div>
            </CardContent>
